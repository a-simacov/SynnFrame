...
data class WizardState(
    ...
    fun getFactLineData(): Map<TaskXLineFieldType, Any?> {
        ...
        results.storageProduct?.let {
            ...
            Timber.d("Using product: ${it.product.name}, quantity: ${it.quantity}")
        }
        ...
        // Устанавливаем значение по умолчанию для WMS_ACTION, если не задано
